...
$env:MSPEC = "$env:HOMEPATH\.nuget\packages\Machine.Specifications.Runner.Console\0.9.3\tools\mspec-clr4.exe"
$env:OPENCOVER = "$env:HOMEPATH\.nuget\packages\OpenCover\4.6.519\tools\OpenCover.Console.exe"
$env:COVERALLS = "$env:HOMEPATH\.nuget\packages\coveralls.io\1.4.2\tools\coveralls.net.exe"
exit 0