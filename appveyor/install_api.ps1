...
{
    $cmd = "dotnet tool upgrade dotnet-reportgenerator-globaltool --tool-path buildtools/"
    RunCmd $cmd
}
...
{
    $cmd = "dotnet tool upgrade coveralls.net --version 1.0.0 --tool-path buildtools/"
    RunCmd $cmd    
}
...
{
    $cmd = "dotnet tool upgrade dotnet-sonarscanner --tool-path buildtools/"
    RunCmd $cmd    
}
